  ...
  return (
    <Container className="mt-5">
      <Row>
        ...
        <img src="https://www.looksgud.in/upload/item-image/2274/1cr9u/1cr9u-feel-close-knee-length-one-piece-dress-for-girls-and-ladies_500x500_0.jpg" alt="vpn" className="img1" width="90%" />
        ...
        <Col className="mt-5" lg={6} xs={12} sm={12} md={6} xl={6}>
          ...
          <h2 className="text-danger">Black Sport</h2>
          <p>
